...
const ListaCursosAsistenciaScreen =({ navigation }:Props)=> {
    
    return (
    <View style={styles.fondoApp}>
    <SafeAreaView><Text style={styles.title}>ListaCursosAsistenciaScreen</Text></SafeAreaView>       
...
export default ListaCursosAsistenciaScreen;